        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ME](https://t.me/Stranger_of_Telegram) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""━ ɪs ᴡᴏʀᴋɪɴɢ ᴀɴᴅ ғᴜɴᴄᴛɪᴏɴɪɴɢ ᴘʀᴏᴘᴇʀʟʏ\n✪ ᴛʜᴀɴᴋs ᴛᴏ ʏᴜᴋᴋɪ ᴛᴇᴀᴍ 🌼 ..""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 DANGER BOTS", url=f"https://t.me/dangerbots")]]
        ),
    )


@app.on_message(commandpro(["/verify", "lunaverification"]) & ~filters.edited)
async def start(client: Client, message: Message):
    ...
    await add_served_user(message.from_user.id)
    await message.reply_photo(
        photo=f"https://graph.org/file/d85008ea723ae8184b31a.jpg",
        caption=f"""━ \n\n✪ **ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴ** 🎉\n✪ ɴᴏᴡ ʏᴏᴜ ᴀʀᴇ LUNA ᴠᴇʀɪғɪᴇᴅ ᴍᴇᴍʙᴇʀ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴇɴᴊᴏʏ ᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜsɪᴄ 🌼 ..\n\n━ ..""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("DANGER BOTS", url=f"https://t.me/dangerbots")]]
        ),
    )
